...
echo "@@@@@ TEST: LEGIT-RM (--force --cached) @@@@@"
echo
...
echo "COMMAND: ../legit-rm --force --cached b"
../legit-rm --force b
echo

echo "COMMAND: ../legit-rm --force --cached c"
../legit-rm --force c
echo

echo "COMMAND: ../legit-rm --force --cached d"
../legit-rm --force d
echo

echo "COMMAND: ../legit-rm --force --cached e"
../legit-rm --force e
echo
